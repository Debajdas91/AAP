CLASS zcl_GE289149_generate_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_GE289149_generate_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA demo_data TYPE STANDARD TABLE OF ZGE289149.
    DATA demo_data_line TYPE ZGE289149.
    ...
    INSERT zGE289149 FROM TABLE @demo_data.

    COMMIT WORK.

    SELECT * FROM zGE289149 INTO TABLE @demo_data.
