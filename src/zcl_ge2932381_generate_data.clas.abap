CLASS zcl_GE2932381_generate_data DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_GE2932381_generate_data IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.
    DATA demo_data TYPE STANDARD TABLE OF zGE293238_1.
    DATA demo_data_line TYPE zGE293238_1.
    ...
    INSERT zGE293238_1 FROM TABLE @demo_data.

    COMMIT WORK.

    SELECT * FROM zGE293238_1 INTO TABLE @demo_data.
